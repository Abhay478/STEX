...
Widget questionPreviewCard(BuildContext context, Post question) {
...
Widget questionPreviewList(BuildContext context, List<Post>? questions) {
  if (questions == null) {
    ...
    Container(
      ...
      child: ListView(
        children: questions.map((question) => questionPreviewCard(context, question)).toList(), 
      )
    );
  }
}
