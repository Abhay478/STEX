...
use crate::{Pool, diesel_stex::models::*, auth_stex::models::AppState};
...
#[get("/auto/u")]
pub async fn get_names(state: web::Data<AppState>, prefix: web::Query<AutocParams>) -> impl Responder {
    let db = &state.pool;
...
#[get("/auto/t")]
pub async fn get_tags(state: web::Data<AppState>, prefix: web::Query<AutocParams>) -> impl Responder {
    let db = &state.pool;
...
#[get("/auto/p")]
pub async fn get_posts(state: web::Data<AppState>, prefix: web::Query<AutocParams>) -> impl Responder {
    let db = &state.pool;
...
pub async fn get_post_by_title(state: web::Data<AppState>, title: web::Query<AutocParams>) -> impl Responder {
    let db = &state.pool;
...
pub async fn get_post_by_owner(state: web::Data<AppState>, oid: web::Query<AutocParams>) -> impl Responder {
    let db = &state.pool;
...
#[get("/search/post_tag")]
pub async fn get_post_by_tag(state: web::Data<AppState>, tag: web::Query<AutocParams>) -> impl Responder {
    let db = &state.pool;
...
#[post("/post/new")]
pub async fn insert_post(state: web::Data<AppState>, new: web::Json<NewPost>) -> impl Responder {
    let db = &state.pool;
...
#[post("/post/answer")]
pub async fn answer_to_post(state: web::Data<AppState>, new: web::Json<AnswerPost>) -> impl Responder {
    let db = &state.pool;
...
#[post("/post/update")]
pub async fn update_post(state: web::Data<AppState>, new: web::Json<NewPost>) -> impl Responder {
    let db = &state.pool;
...
#[delete("/post/delete")]
pub async fn delete_post(state: web::Data<AppState>, kill: web::Query<AutocParamsInt>) -> impl Responder {
    let db = &state.pool;
